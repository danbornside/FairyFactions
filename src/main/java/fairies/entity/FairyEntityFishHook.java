...
public class FairyEntityFishHook extends Entity
{
    ...
    public FairyEntityFishHook(World par1World)
    {
        super(par1World);
        this.xTile = -1;
        this.yTile = -1;
    ...
    public FairyEntityFishHook(World par1World, double par2, double par4, double par6)
    {
        this(par1World);
    ...
    public FairyEntityFishHook(World par1World, EntityFairy fairy)
    {
        super(par1World);
        this.xTile = -1;
        this.yTile = -1;
    ...
    {
        if (ridingEntity != null && ridingEntity instanceof EntityFairy)  //Client sided only
        {
            ridingEntity.riddenByEntity = null;
            ((EntityFairy)ridingEntity).fishEntity = this;
            this.angler = (EntityFairy)ridingEntity;
